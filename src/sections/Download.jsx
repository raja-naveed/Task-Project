    ...
    <div className="container mx-auto flex flex-col justify-between items-center min-h-screen gap-8">
      ...
      <div className="flex justify-between gap-8 lg:gap-0 flex-col lg:flex-row lg:items-center">
        <div className="w-[250px] 2xl:w-[400px] 3xl:w-[549px] flex justify-between mx-auto gap-x-16" >
          <img  className="w-[120px] 2xl:w-[192px] 3xl:w-[246px]" src="/images/react.svg" alt="" />
          <div className="flex flex-col justify-between items-center text-center gap-x-16 2xl:h-[600px] 3xl:h-[800px] 3xl:pt-[50px]">
            ...
            <div>
              <a href="https://play.google.com/store/apps/details?id=com.whatsapp&amp;hl=en&amp;gl=US" target="_blank" className="block w-[135px] mx-auto" >
                <img src="/images/android.png" className="h-[45px] w-[135px]" alt="" />
              </a>

              <a href="https://apps.apple.com/us/app/whatsapp-messenger/id310633997" target="_blank" className="block w-[135px] mx-auto" >
                <img src="/images/ios.png" className="h-[45px] w-[135px] mt-4 mb-5" alt="" />
              </a>
        ...
        <div className="w-[250px] 2xl:w-[400px] 3xl:w-[549px] relative flex mx-auto " >
          <img className="w-[107px] 2xl:w-[172px] 3xl:w-[236px] relative z-10" src="/images/android-1.svg" alt="" />
          <img className="w-[204px] 2xl:w-[327px] 3xl:w-[449px] relative -left-12 lg:absolute top-0 lg:left-12 2xl:left-24" src="/images/android-2.svg" alt="" />
        </div>
      </div>
